...
import ManageAccount from './elements/manageAccount';
...
class Manage extends React.Component {
  ...
  render() {
    return (
      <ManageAccount eos={this.eos} scatterEos={ this.props.accountReducer.scatterEosObj } scatterDetectionStr={ this.props.accountReducer.scatterDetectionStr } config={ this.props.config } eosAccountStr={ this.props.accountReducer.eosAccountStr } selection={ this.props.selection } eosAccountAuthorityStr={ this.props.accountReducer.eosAccountAuthorityStr } scatterHelper={this.scatterHelper} />
    );
  }
