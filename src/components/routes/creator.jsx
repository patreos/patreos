...
import CreatorPage from './elements/creatorPage';
...
class Creator extends React.Component {
  ...
  render() {
    return (
      <CreatorPage eos={this.eos} scatterEos={ this.props.accountReducer.scatterEosObj } scatterDetectionStr={ this.props.accountReducer.scatterDetectionStr } config={ this.props.config } eosAccountStr={ this.props.match.params.account } eosAccountAuthorityStr={ this.props.accountReducer.eosAccountAuthorityStr } scatterHelper={this.scatterHelper} />
    );
  }
